...
报工详情页采用 Tab 页签式布局，顶部信息区展示以下统计数据：

| 统计项 | 说明 | 颜色 |
|--------|------|------|
| 报工数量 | 报工单报工产出数量 | 蓝色 #1677ff |
| 投入数量 | 第一道工序投入 - 退回 | 绿色 #52c41a |
| 预计产出/合格数量 | 投入 - 不良 - 检验报废 | 橙色 #fa8c16 |
| 来料不良 | defect_type=来料不良 的不良数量汇总 | 红色 #ff4d4f |
| 制程不良 | 除来料不良、检验报废外的不良数量汇总 | 金色 #faad14 |
| 检验报废 | defect_type=检验报废 的不良数量汇总 | 紫色 #722ed1 |
| 异常工时 | 所有异常记录时长汇总（无结束时间时取当前时间计算） | 粉色 #eb2f96 |
| 人工工时 | 所有人员记录的人时汇总 | 青色 #13c2c2 |
