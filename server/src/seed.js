...
async function seed() {
  try {
    ...
    await Material.bulkCreate([
      { material_id: 1, material_code: 'ML-900-A', material_name: '900g奶粉罐', specification: '900g奶粉罐', film_version: 'A312-012-0001', version_no: 'V1', category_code: 'C01', category_name: '成品罐', customer_code: 'CUST-001', customer_name: '伊利乳业', unit: '个', min_safety_stock: 5000, max_safety_stock: 50000, status: 1 },
      { material_id: 2, material_code: 'ML-400-B', material_name: '400g奶粉罐', specification: '400g奶粉罐', film_version: 'A312-013-0002', version_no: 'V1', category_code: 'C01', category_name: '成品罐', customer_code: 'CUST-002', customer_name: '蒙牛乳业', unit: '个', min_safety_stock: 3000, max_safety_stock: 30000, status: 1 },
      { material_id: 3, material_code: 'ML-800-C', material_name: '800g奶粉罐', specification: '800g奶粉罐', film_version: 'A312-014-0003', version_no: 'V2', category_code: 'C01', category_name: '成品罐', customer_code: 'CUST-003', customer_name: '飞鹤乳业', unit: '个', min_safety_stock: 4000, max_safety_stock: 40000, status: 1 },
      { material_id: 4, material_code: 'ML-1200-D', material_name: '1200g奶粉罐', specification: '1200g奶粉罐', film_version: 'A312-015-0004', version_no: 'V1', category_code: 'C01', category_name: '成品罐', customer_code: 'CUST-004', customer_name: '君乐宝', unit: '个', min_safety_stock: 2000, max_safety_stock: 20000, status: 2 },
      { material_id: 5, material_code: 'MT-MAR-A', material_name: '马口铁基材', specification: '0.23mm镀锡板', film_version: '-', version_no: '-', category_code: 'C02', category_name: '原材料', customer_code: '-', customer_name: '-', unit: '片', min_safety_stock: 10000, max_safety_stock: 100000, status: 1 },
    ])
    ...
    await WorkOrder.bulkCreate([
      { work_order_id: 1, work_order_no: 'WO20260630001', order_id: 1, order_no: 'MO-16260630001', line_id: 1, line_name: 'A线', material_id: 1, material_name: '900g奶粉罐', target_qty: 20000, finished_qty: 4983, start_time: '2026-06-30 08:00', finish_time: null, total_hours: 0, effective_hours: 0, labor_hours: 0, status: 1, created_by: 'pm' },
      { work_order_id: 2, work_order_no: 'WO20260629001', order_id: 3, order_no: 'MO-16260629001', line_id: 2, line_name: 'B线', material_id: 3, material_name: '800g奶粉罐', target_qty: 10000, finished_qty: 9965, start_time: '2026-06-29 08:00', finish_time: '2026-06-30 17:00', total_hours: 33.0, effective_hours: 30.5, labor_hours: 244.0, status: 2, created_by: 'pm' },
      { work_order_id: 3, work_order_no: 'WO20260628001', order_id: 4, order_no: 'MO-16260628001', line_id: 1, line_name: 'A线', material_id: 1, material_name: '900g奶粉罐', target_qty: 18000, finished_qty: 18000, start_time: '2026-06-28 08:00', finish_time: '2026-06-30 16:30', total_hours: 56.5, effective_hours: 52.0, labor_hours: 416.0, status: 3, created_by: 'pm' },
      { work_order_id: 4, work_order_no: 'WO20260701001', order_id: 2, order_no: 'MO-16260630002', line_id: 1, line_name: 'A线', material_id: 2, material_name: '400g奶粉罐', target_qty: 15000, finished_qty: 0, start_time: '2026-07-02 08:00', finish_time: null, total_hours: 0, effective_hours: 0, labor_hours: 0, status: 0, created_by: 'pm' },
    ])
