...
const seedOrder = [
  ...
  { name: 'ReportOrder', model: ReportOrder, label: '生产报工单' },
  { name: 'ReportProcess', model: ReportProcess, label: '报工工序' },
  { name: 'ProcessDefect', model: ProcessDefect, label: '工序不良' },
  { name: 'ProcessMaterial', model: ProcessMaterial, label: '工序物料' },
  { name: 'ProcessException', model: ProcessException, label: '异常工时记录' },
  { name: 'ManpowerRecord', model: ManpowerRecord, label: '人员投入' },
  { name: 'ReportImage', model: ReportImage, label: '报工图片' },
