...
const defaultPermissions = [
  ...
  // 设备管理
  { perm_id: 50, parent_id: 0, perm_name: '设备管理', perm_code: 'device', type: 'menu', icon: 'ToolOutlined', path: 'device', sort_order: 5 },
  ...
  // 报表中心
  { perm_id: 70, parent_id: 0, perm_name: '报表中心', perm_code: 'report', type: 'menu', icon: 'PieChartOutlined', path: 'report', sort_order: 7 },
