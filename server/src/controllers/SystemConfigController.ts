...
const tableCategoryMap = {
  ...
  production_work_order: { category: '业务表', purpose: '生产工单表，记录生产工单信息、计划数量及工时计算数据，关联工单工序表' },
  production_work_order_process: { category: '业务表', purpose: '生产工单工序表，从产线工序表继承，记录工单关联的工序及排序信息' },
  production_process_report: { category: '业务表', purpose: '工序报工主表，记录工单报工主要信息及统计数据（投入/不良/报废/合格数量从不良记录表和物料记录表聚合）' },
  production_manpower_record: { category: '业务表', purpose: '工单人员投入记录表，记录工单的人员配置、班次及工时信息' },
  production_process_exception: { category: '业务表', purpose: '工单异常工时记录表，记录生产异常及关联设备信息' },
  production_process_defect: { category: '业务表', purpose: '工序不良记录表，仅记录外键关联，详情通过关联不良分类表查询获取' },
  production_process_material: { category: '业务表', purpose: '工序物料记录表，仅记录外键关联，详情通过关联基础料品表查询获取' },
  production_report_exception_image: { category: '业务表', purpose: '报工异常图片记录表，存储报工单关联的异常图片' },
}
...
const columnCommentMap = {
  ...
  production_work_order: {
    ...
    target_qty: '目标数量',
    planned_qty: '计划数量',
    finished_qty: '已完成数量（统计字段：合格数量汇总）',
    start_qty: '投入数量（统计字段：物料记录表投入数量汇总）',
    qualified_qty: '合格数量（统计字段：投入-不良-报废）',
    defect_material: '物料不良数量（统计字段：不良记录表物料不良分类汇总）',
    defect_process: '制程不良数量（统计字段：不良记录表制程不良分类汇总）',
    defect_scrap: '检验报废数量（统计字段：不良记录表检验报废分类汇总）',
    plan_start_time: '计划开始时间',
    plan_end_time: '计划完成时间',
    start_time: '开工时间',
    finish_time: '完工时间',
    ...
    labor_hours: '人工工时',
    status: '工单状态（0开立 1开工 2关闭）',
    report_status: '报工状态（0开始报工 1结束报工）',
    created_by: '创建人',
    remarks: '备注信息',
    created_at: '创建时间',
    updated_at: '更新时间',
  ...
  production_work_order_process: {
    id: '主键ID',
    work_order_id: '工单ID（关联production_work_order）',
    process_id: '工序ID（关联master_process）',
    process_code: '工序编码',
    process_name: '工序名称',
    has_material: '是否引入物料（是/否）',
    sort_order: '排序号',
    created_at: '创建时间',
    updated_at: '更新时间',
  },
  production_process_report: {
    ...
    work_order_id: '工单ID',
    work_order_no: '工单编号',
    report_count: '报工次数（同一工单的第N次报工）',
    process_id: '工序ID',
    process_name: '工序名称',
    input_qty: '投入数量（统计字段）',
    defect_material: '物料不良数量（统计字段）',
    defect_process: '制程不良数量（统计字段）',
    defect_scrap: '检验报废数量（统计字段）',
    output_qty: '产出数量（统计字段）',
    device_id: '设备ID',
    device_name: '设备名称',
    report_user: '报工人账号',
  ...
  production_manpower_record: {
    record_id: '记录ID（主键）',
    report_id: '报工单ID（关联production_process_report）',
    work_order_id: '工单ID（关联production_work_order）',
    work_order_no: '工单编号',
    record_date: '记录日期',
    shift: '班次',
