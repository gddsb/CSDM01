...
const defaultPermissions = [
  ...
  { perm_id: 33, parent_id: 30, perm_name: '产品检测', perm_code: 'quality:product', type: 'menu', icon: 'ExperimentOutlined', path: '/quality/product', sort_order: 2 },
  { perm_id: 35, parent_id: 30, perm_name: '微生物检验', perm_code: 'quality:microbe', type: 'menu', icon: 'ExperimentOutlined', path: '/quality/microbe', sort_order: 3 },
  { perm_id: 36, parent_id: 30, perm_name: '环境检验', perm_code: 'quality:environment', type: 'menu', icon: 'ExperimentOutlined', path: '/quality/environment', sort_order: 4 },
  { perm_id: 37, parent_id: 30, perm_name: '投诉管理', perm_code: 'quality:complaint', type: 'menu', icon: 'BellOutlined', path: '/quality/complaints', sort_order: 5 },
  ...
  { perm_id: 40, parent_id: 30, perm_name: '检测仪器管理', perm_code: 'quality:instrument', type: 'menu', icon: 'ToolOutlined', path: '/quality/instruments', sort_order: 6 },
  { perm_id: 41, parent_id: 30, perm_name: '检验标准项目维护', perm_code: 'quality:standard-item', type: 'menu', icon: 'FileSearchOutlined', path: '/quality/standard-items', sort_order: 7 },
  // 设备管理
