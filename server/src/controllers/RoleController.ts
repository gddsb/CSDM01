...
const defaultPermissions = [
  ...
  { parent_id: 0, parent_code: 'device', perm_name: '保养管理', perm_code: 'device:maintenance', type: 'menu', icon: 'ToolOutlined', path: '/device/maintenance', sort_order: 2 },
  { parent_id: 0, parent_code: 'device', perm_name: '保养矩阵', perm_code: 'device:maintenance-matrix', type: 'menu', icon: 'AppstoreOutlined', path: '/device/maintenance/matrix', sort_order: 3 },
  ...
  { parent_id: 0, parent_code: 'device', perm_name: '备件管理', perm_code: 'device:spare-part', type: 'menu', icon: 'InboxOutlined', path: '/device/spare-parts', sort_order: 7 },
  { parent_id: 0, parent_code: 'device', perm_name: '校准管理', perm_code: 'device:calibration', type: 'menu', icon: 'AimOutlined', path: '/device/calibration', sort_order: 8 },
  { parent_id: 0, parent_code: 'device', perm_name: '电子档案', perm_code: 'device:document', type: 'menu', icon: 'FolderOutlined', path: '/device/documents', sort_order: 9 },
  // 报表中心
