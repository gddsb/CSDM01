...
const defaultPermissions = [
  ...
  { parent_id: 10, perm_name: '供应商档案', perm_code: 'basic:supplier', type: 'menu', icon: 'ShopOutlined', path: '/basic/suppliers', sort_order: 3 },
  { parent_id: 10, perm_name: '产线档案', perm_code: 'basic:line', type: 'menu', icon: 'DeploymentUnitOutlined', path: '/basic/lines', sort_order: 4 },
  { parent_id: 10, perm_name: '工序档案', perm_code: 'basic:process', type: 'menu', icon: 'DeploymentUnitOutlined', path: '/basic/processes', sort_order: 5 },
  { parent_id: 10, perm_name: '不良分类', perm_code: 'basic:defect', type: 'menu', icon: 'AlertOutlined', path: '/basic/defects', sort_order: 6 },
  { parent_id: 10, perm_name: '编码管理', perm_code: 'basic:number-rule', type: 'menu', icon: 'KeyOutlined', path: '/basic/number-rules', sort_order: 7 },
  // 生产管理
