  ...
  try {
    ...
    const columnCommentMap = {
      ...
      master_device: {
        ...
        process_id: '所属工序ID',
        process_name: '所属工序名称',
        status: '设备状态（1运行 2维修 3停用）',
        last_maintenance_date: '上次维护日期',
        next_maintenance_date: '下次维护日期',
        special_equipment: '是否特种设备（1是 0否）',
        inspection_date: '特种设备检定日期',
        inspection_expire_date: '特种设备检定有效期',
        remark: '备注',
        created_by: '创建人',
        updated_by: '更新人',
        created_at: '创建时间',
      ...
      production_order: {
        ...
        unit: '单位',
        delivery_date: '交货日期',
        order_status: '订单状态（1开立 2已下达 3已关闭）',
        priority: '优先级',
        line_id: '指定产线ID',
        line_name: '指定产线名称',
        remark: '备注',
      ...
      production_work_order: {
        ...
        defect_qty: '不良数量',
        unit: '单位',
        work_order_status: '工单状态（1开立 2开工 3完工 4关闭）',
        start_time: '开工时间',
        finish_time: '完工时间',
        standard_hours: '标准工时',
        actual_hours: '实际工时',
      ...
      production_exception_record: {
        ...
        cause_analysis: '原因分析',
        solution: '解决方案',
        status: '处理状态（1待处理 2处理中 3已处理 4已关闭）',
        handler: '处理人',
        handle_time: '处理时间',
        remark: '备注',
        created_by: '创建人',
