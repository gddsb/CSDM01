...
// 工序报工记录
export const processReports: any[] = [
...
// 人员投入记录
export const manpowerRecords: any[] = [
...
// 异常工时记录
export const exceptionRecords: any[] = [
...
// 检验标准
export const inspectionStandards: any[] = [
...
// 来料检验
export const incomingInspections: any[] = [
...
// 成品检验
export const finishedInspections: any[] = [
...
// 微生物检验
export const microbeInspections: any[] = [
...
// 环境检验
export const envInspections: any[] = [
...
// 供应商投诉
export const supplierComplaints: any[] = [
