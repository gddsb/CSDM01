...
const tableFieldsMap = {
  ...
  master_defect_type: [
    ...
    { field_name: 'defect_type', field_type: 'string', field_length: '50', is_required: '否', description: '不良大类' },
    ...
    { field_name: 'defect_description', field_type: 'string', field_length: '500', is_required: '否', description: '不良描述' },
    { field_name: 'created_at', field_type: 'date', field_length: '-', is_required: '是', description: '创建时间' },
    { field_name: 'updated_at', field_type: 'date', field_length: '-', is_required: '否', description: '更新时间' },
  ],
  bas_line_process: [
