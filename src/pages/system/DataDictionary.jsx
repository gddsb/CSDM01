...
const tableFieldsMap = {
  ...
  master_defect_type: [
    ...
    { field_name: 'defect_type', field_type: 'string', field_length: '50', is_required: '否', description: '分类名称（二级分类）：来料不良/制程不良/检验报废' },
    { field_name: 'category_name', field_type: 'string', field_length: '50', is_required: '否', description: '大类名称（一级分类）：来料检验类/制程检验类' },
    ...
    { field_name: 'category_desc', field_type: 'string', field_length: '500', is_required: '否', description: '分类名称/不良描述' },
    { field_name: 'created_at', field_type: 'date', field_length: '-', is_required: '是', description: '创建时间' },
    { field_name: 'updated_at', field_type: 'date', field_length: '-', is_required: '否', description: '更新时间' },
  ],
  bas_line_process: [
